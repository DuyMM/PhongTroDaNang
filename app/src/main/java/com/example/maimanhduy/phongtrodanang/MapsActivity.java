...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    private void findpath() {
        ...
        mDiaChi = prefs.getString("diachi", "Đà Nẵng");
        String destination = mDiaChi;
        if (origin.isEmpty()) {
            return;
        }
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            ((TextView) findViewById(R.id.km)).setText(route.duration.text);
            ((TextView) findViewById(R.id.timetogo)).setText(route.distance.text);
